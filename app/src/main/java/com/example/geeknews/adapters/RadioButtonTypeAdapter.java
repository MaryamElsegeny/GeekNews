...
public class RadioButtonTypeAdapter extends RecyclerView.Adapter<RadioButtonTypeAdapter.RadioButtonViewHolder>{

    private ArrayList<RadioButtonModel> modelArrayList;

    private Context context ;

    public RadioButtonTypeAdapter(ArrayList<RadioButtonModel> modelArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull RadioButtonViewHolder holder, int position) {
        ...
        holder.filterRadioBtn.setText(radioButtonModel.getRadBtnType());
